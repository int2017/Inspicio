...
{
    public partial class sprint4End_init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfileName = table.Column<string>(maxLength: 16, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommentUrgency = table.Column<int>(nullable: false),
                    ImageId = table.Column<int>(nullable: false),
