...
namespace Inspicio.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [HttpGet]
        [AllowAnonymous]
        public async Task<IActionResult> LoginOrRegister(string returnUrl = null)
        {
        ...
        public async Task<IActionResult> Register(LogRegModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                AddErrors(IdentityResult.Failed(new IdentityError { Description = "Profile Name already taken" }));
            }
